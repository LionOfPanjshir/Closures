 ...
 */
//let forward = { (name1: String, name2: String) -> Bool in print(name1)  name1 < name2 }
...
//let forward = { (name1: String, name2: String) -> Bool in print name1}
...
var familyNames = ["David", "Melanie", "Matthew", "Katiana"]
let sortedCollection1 = familyNames.sorted(by: forward(name1:name2:))
...
let sortedCollection2 = familyNames.sorted { return $0 < $1 }
